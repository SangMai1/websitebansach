...
@section('content')
  ...
  <div class="main-content">
    ...
    <!-- Button trigger modal -->
      <a href="/api/danh-muc/them-moi" class="btn btn-primary" id="createNewBook">
        Thêm mới
      </a>
      <form>
        <div class="row">
     ...
     success:function(data)
     {
       ...
       var _html = '';
            $.each(data, function(index, value){
              let edit = "/api/danh-muc/edit/" + value.id;
              let delete1 = "/api/danh-muc/delete/" + value.id;
              _html += '<tr class="sang">';
