...
@section('content')
  ...
  <div class="main-content">
    ...
    <!-- Button trigger modal -->
      <a href="/api/sach/them-moi" class="btn btn-primary" id="createNewBook">
        Thêm mới
      </a>
      <form>
        <div class="row">
     ...
     success:function(data)
     {
       ...
       var _html = '';
            $.each(data, function(index, value){
              let edit = "/api/sach/edit/" + value.id;
              let delete1 = "/api/sach/delete/" + value.id;
