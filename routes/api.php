...
Route::group(['prefix' => '/categories'], function(){
    Route::get('/create', 'App\Http\Controllers\Api\CategoriesController@create')->name('categories.create')->middleware('authencation');
    Route::post('/create', 'App\Http\Controllers\Api\CategoriesController@store')->name('categories.store');
    Route::get('/edit/{id}', 'App\Http\Controllers\Api\CategoriesController@edit')->name('categories.edit')->middleware('authencation');
    Route::post('/update/{id}', 'App\Http\Controllers\Api\CategoriesController@update')->name('categories.update');
    Route::get('/delete/{id}', 'App\Http\Controllers\Api\CategoriesController@destroy')->name('categories.delete')->middleware('authencation');
    Route::get('/list', 'App\Http\Controllers\Api\CategoriesController@index')->name('categories.list')->middleware('authencation');
...
Route::group(['prefix' => '/slide'], function(){
    Route::get('/create', 'App\Http\Controllers\Api\SlidesController@create')->name('slides.create')->middleware('authencation');
    Route::post('/create', 'App\Http\Controllers\Api\SlidesController@store')->name('slides.store');
    Route::get('/edit/{id}', 'App\Http\Controllers\Api\SlidesController@edit')->name('slides.edit')->middleware('authencation');
    Route::post('/update/{id}', 'App\Http\Controllers\Api\SlidesController@update')->name('slides.update');
    Route::get('/delete/{id}', 'App\Http\Controllers\Api\SlidesController@destroy')->name('slides.delete')->middleware('authencation');
    Route::get('/list', 'App\Http\Controllers\Api\SlidesController@index')->name('slides.list')->middleware('authencation');
...
Route::group(['prefix' => '/book'], function(){
    Route::get('/create', 'App\Http\Controllers\Api\BooksController@create')->name('books.create')->middleware('authencation');
    Route::post('/create', 'App\Http\Controllers\Api\BooksController@store')->name('books.store');
    Route::get('/edit/{id}', 'App\Http\Controllers\Api\BooksController@edit')->name('books.edit')->middleware('authencation');
    Route::post('/update/{id}', 'App\Http\Controllers\Api\BooksController@update')->name('books.update');
    Route::get('/delete/{id}', 'App\Http\Controllers\Api\BooksController@destroy')->name('books.delete')->middleware('authencation');
    Route::get('/list', 'App\Http\Controllers\Api\BooksController@index')->name('books.list')->middleware('authencation');
...
Route::group(['prefix' => '/warehouse'], function(){
    ...
    Route::get('/list', 'App\Http\Controllers\Api\WarehousesController@index')->name('warehouse.list')->middleware('authencation');
...
Route::group(['prefix' => '/customer'], function(){
    ...
    Route::get('/list', 'App\Http\Controllers\Api\CustomersController@index')->name('customer.list')->middleware('authencation');
...
Route::group(['prefix' => '/mission'], function(){
    Route::get('/create', 'App\Http\Controllers\Api\MissionsController@create')->name('mission.create')->middleware('authencation');
    Route::post('/create', 'App\Http\Controllers\Api\MissionsController@store')->name('mission.store');
    Route::get('/edit/{id}', 'App\Http\Controllers\Api\MissionsController@edit')->name('mission.edit')->middleware('authencation');
    Route::post('/update/{id}', 'App\Http\Controllers\Api\MissionsController@update')->name('mission.update');
    Route::get('/delete/{id}', 'App\Http\Controllers\Api\MissionsController@destroy')->name('mission.delete')->middleware('authencation');
    Route::get('/list', 'App\Http\Controllers\Api\MissionsController@index')->name('mission.list')->middleware('authencation');
...
Route::group(['prefix' => '/user'], function(){
    Route::get('/create', 'App\Http\Controllers\Api\UsersController@create')->name('user.create')->middleware('authencation');
    Route::post('/create', 'App\Http\Controllers\Api\UsersController@store')->name('user.store');
    Route::get('/edit/{id}', 'App\Http\Controllers\Api\UsersController@edit')->name('user.edit')->middleware('authencation');
    Route::post('/update/{id}', 'App\Http\Controllers\Api\UsersController@update')->name('user.update');
    Route::get('/delete/{id}', 'App\Http\Controllers\Api\UsersController@destroy')->name('user.delete')->middleware('authencation');
    Route::get('/list', 'App\Http\Controllers\Api\UsersController@index')->name('user.list')->middleware('authencation');
...
Route::group(['prefix' => '/order-admin'], function(){
    ...
    Route::get('/danh-sach', 'App\Http\Controllers\Api\OrdersController@index')->name('orderadmin.list')->middleware('authencation');
...
Route::group(['prefix' => '/review'], function(){
    ...
    Route::get('/get-list', 'App\Http\Controllers\Api\ReviewsController@get_list')->name('review.getlist')->middleware('authencation');
